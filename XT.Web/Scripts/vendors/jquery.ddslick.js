...
(function ($) {
    ...
    methods.init = function (options) {
        ...
        return this.each(function () {
            ...
            if (!data) {
                ...
                if (obj.data("selectValue")) {
                    var val = obj.data("selectValue");
                    for (var i = 0; i < ddSelect.length; i++)
                    {
                        if (ddSelect[i].value == val)
                        {
                            currentIndex = i;
                            break;
                        }
    ...
    function selectIndex(obj, index, onselect) {
        ...
        if (typeof settings.onSelected == 'function' && onselect) {
